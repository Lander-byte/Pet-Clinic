  ...
  return (
    <div className="portal-selection-container">
      <div className="portal-selection-header">
        <div className="portal-logo"><PawLogo /></div>
        <h1 className="portal-title">PET CARE PORTAL</h1>
        <p className="portal-subtitle">Select your gateway</p>
      </div>
      ...
      <div className="portal-selection-footer">
        © 2026 Pet Care Veterinary System. All rights reserved.
      </div>
    </div>
  );
}
